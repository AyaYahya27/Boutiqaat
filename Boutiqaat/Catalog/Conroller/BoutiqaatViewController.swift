...
//            cell.configureView(width: UIScreen.main.bounds.width , name: "Product", image: "https://v2cdn.boutiqaat.com/media/catalog/product/M/U/MU-00009118-1.jpg", price: "00.000", description: "Description", currency: "kwd")
////            cell.nameLabel.text = self.boutiqaatViewModel.payload[2].banners[indexPath.row].label
//
//
////            cell.configureView(width: UIScreen.main.bounds.width / 2, name: self.boutiqaatViewModel.payload[2].banners[indexPath.row].brandName! , image: self.boutiqaatViewModel.payload[2].banners[indexPath.row].imageUrl, price: self.boutiqaatViewModel.payload[2].banners[indexPath.row].mrp!, description: self.boutiqaatViewModel.payload[2].banners[indexPath.row].label, currency: self.boutiqaatViewModel.payload[2].banners[indexPath.row].currencyCode!)
////
//            return cell
//
//        }
